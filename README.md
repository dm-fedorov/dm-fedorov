...
**`Области интересов`**:
- 💻 проведение обучающих курсов на основе Python ([**`уроки для изучения`**](https://dfedorov.spb.ru/python3/), [**`перевод уроков по pandas`**](https://dfedorov.spb.ru/pandas/), [**`группа в Telegram`**](https://t.me/init_python));
